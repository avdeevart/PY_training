...
# --------------------------------------------------------------------------------------------------------------------------------
# Я решил усовершенствовать программу и усложнить задание:
# 1. Можно вводить, как слова, так и предложения.
# 2. Не имеет значение в каком регистре вводить.
# 3. Выводится детализация по-буквам введеной фразы/слова
